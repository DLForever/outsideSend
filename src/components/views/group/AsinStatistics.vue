    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>ASIN管理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            <el-table show-summary :summary-method="getSummaries" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading" element-loading-background="rgba(0, 0, 0, 0.8)" :data="data" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column fixed prop="country" label="站点" show-overflow-tooltip>
                </el-table-column>
                ...
                <el-table-column v-if="is_company === '1'" prop="self_pay_price" label="自费总金额" show-overflow-tooltip>
                </el-table-column>
...
//                  this.url = '/ms/table/list';
            ...
            filter_product() {
                if(this.date_filter === null || this.date_filter.length === 0) {
